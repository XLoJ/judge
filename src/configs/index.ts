...
export const PROBLEM_PATH = path.join(RUN_PATH, 'problems');
const CHK_PATH = path.join(RUN_PATH, 'checker');
const INT_PATH = path.join(RUN_PATH, 'interactor');
const GEN_PATH = path.join(RUN_PATH, 'generator');
const VAL_PATH = path.join(RUN_PATH, 'validator');
